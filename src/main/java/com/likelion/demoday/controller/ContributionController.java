...
public class ContributionController {
    ...
    // 펀딩 참여 생성 + 가상계좌 발급
    @PostMapping
    public ResponseEntity<BaseResponse<CreateContributionResponse>> createContribution(
    ...
    // 참여 및 결제 상태 조회
    @GetMapping("/{id}")
    public ResponseEntity<BaseResponse<PaymentStatusResponse>> getContributionStatus(@PathVariable Long id) {
    ...
    public ResponseEntity<BaseResponse<ContributionResponse>> getContributionDetail(@PathVariable Long id) {
